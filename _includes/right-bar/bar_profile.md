    ...
    <div class="space-y-4">
      ...
      {% if page.profiles.odmeny or page.profiles.evidence or page.profiles.report %}
        <div>
          ...
          {% if page.profiles.odmeny %}{% include contact-line.html icon="ico--xxx bi bi-credit-card-fill" href=page.profiles.odmeny caption="Příjmy z veřejných zdrojů" %}{% endif %}
