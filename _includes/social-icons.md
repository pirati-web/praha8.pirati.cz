{% if include.profiles.facebook %}<a class="social-icon" target="_blank" rel="me noreferrer noopener" href="{{ include.profiles.facebook }}"><i class="ico--xxx bi bi-facebook"></i></a>{% endif %}
