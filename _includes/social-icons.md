...
{% if include.profiles.twitter %}<a class="social-icon" target="_blank" rel="noreferrer noopener" href="{{ include.profiles.twitter }}"><i class="ico--xxx bi bi-twitter-x"></i></a>{% endif %}
...
{% if include.profiles.threads %}<a class="social-icon" target="_blank" rel="noreferrer noopener" href="{{ include.profiles.threads }}"><i class="ico--xxx bi bi-threads"></i></a>{% endif %}
