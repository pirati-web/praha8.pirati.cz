...
Budeme usilovat o posílení veřejného dohledu nad jednotlivými gescemi a firmami v majetku MČ Praha 8. Jasně v této strategii deklarujeme, že nepodpoříme svými hlasy kroky, které by byly v přímém rozporu s těmito záměry. Posilování veřejného dohledu je nejen tím, co od nás voliči na prvním místě očekávají.
...
Vyjednávací tým může zřizovat subtýmy pro jednotlivé oblasti (například doprava, územní rozvoj, sociální věci, kultura a další) za účasti dalších členů, místního fóra či odborníků, vždy však za účasti jednoho člena hlavního vyjednávacího týmu, aby se udržovat celkový přehled o projednávaných a vyjednaných záležitostech. 
 
Vyjednávací tým zřídí pro členy strany v Praze 8 neveřejné vlákno na Zulipu, kde bude neprodleně a bez zbytečného odkladu informovat členskou základnu v Praze 8 o všech proběhlých schůzkách a pokrocích v jednáních. To platí i na dobu před i po volbách.
...
### 3.2. Hned po volbách
- V neděli 25. září se sejde nově zvolený klub zastupitelů a zvolí jeho předsedu a místopředsedu. Klub společně s celým vyjednávacím týmem určí na základě výsledků voleb společně strategii prvních kroků pro vyjednávání. 
- Vyjednávání vede lídr kandidátky. Vyjednávací tým jedná jednotně, rozhoduje kolektivně. Informace o postupu vyjednávacího týmu jsou zasílány na vědomí klubu a místnímu fóru jako celku. Lídr má na starosti také hlavní mediální výstupy z jednání.
...
Na starostu městské části Praha 8 nominujeme lídra kandidátky. Budeme v jednáních postupovat zodpovědně k voličům a Pirátské straně. Strany, které oslovíme jako první, si určíme v rámci taktiky vyjednávání s ohledem na jejich program, zvolené zastupitele, důvěryhodnost, vystupování v kampani, historickou zkušenost a celostátní politický kontext.
...
Pokud nebudeme součástí Rady, chceme získat taková místa ve výborech zastupitelstva a komisích Rady, abychom měli přístup k aktuálním informacím, mohli maximálně prosazovat náš program a pravidla transparence, případně také zasáhnout při podezření na pochybné aktivity. Jako opoziční strana si budeme požadovat předsedání kontrolnímu výboru. Naše opozice bude konstruktivní a motivovaná veřejným zájmem. Formou připomínek, předkládáním návrhů, prací ve výborech, zveřejňováním informací a aktivizací občanské veřejnosti nadále budeme usilovat o prosazování našeho programu.

## 5. Souběh funkcí a obsazování dozorčích rad
Naši zastupitelé kandidující se zavazují, že budou vykonávat max. 1 uvolněnou funkci a řídí se celostátním Všeobecným kodexem veřejného zastupitele.
 
V případě vstupu do koalice budeme usilovat o to, aby dozorčí rady městských firem byly obsazovány koaličními stranami podle poměrného klíče. Poměr se aplikuje na souhrn všech obsazovaných míst a obsazení konkrétních pozic je na dohodě zastupitelských klubů.
...
Nelze-li rozhodnout podle programu či jiných schválených dokumentů, klub konzultuje otázky s  místními či krajskými expertními týmy. místním předsednictvem, místním fórem. Stejně tak tyto orgány se mohou obrátit na klub a ten je povinen s nimi věc projednat.
...
## 7. Závěrem
Tento dokument je součástí volebního programu a kandidáti se svou kandidaturou zavazují k jeho dodržení. Lze jej změnit pouze se souhlasem místního fóra tzv. zásadním rozhodnutím, které upravuje Volební řád - tedy 3/5 tj. 60%.
 
**Místním fórem Praha 8 schváleno dne 2. 9. 2022.**
